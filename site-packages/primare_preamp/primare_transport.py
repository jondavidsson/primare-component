...
class TelnetTransportWrapper(PrimareTransport):
    def __init__(self, host: str, port: int, timeout: int) -> None:
        """Create PrimareTelnet."""
        self.nad_telnet = TelnetTransport(host, port, timeout)

    def __del__(self) -> None:
        """Destroy PrimareTelnet."""
        if self.nad_telnet:
            del self.nad_telnet
...
class TelnetTransport(PrimareTransport):
    """
    Support Primare amplifiers that use telnet for communication.
    ...
    def communicate(self, cmd: str) -> str:
        ...
        # Notice Primare response to command ends with \r and starts with \n
        # E.g. b'\nMain.Power=On\r'
